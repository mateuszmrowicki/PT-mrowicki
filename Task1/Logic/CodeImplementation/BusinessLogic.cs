...
namespace Logic.CodeImplementation
{
    internal class BusinessLogic : IBusinessLogic
    {
        ...
        public override void SellItem(int userID, int stateID, int quantity)
        {
        ...
        public override void SupplyItem(int userID, int stateID, int quantity)
        {
            DR.AddEvent(new Supply(stateID, userID, quantity));
            DR.ChangeQuantity(stateID, quantity);
        }
        public override void ReturnItem(int userID, int stateID, int quantity)
        {
